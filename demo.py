...
with safe_device(_DEVICE_ID) as device:
    device.swipe([(200, 100), (300, 400), (200, 500)], duration=500, pressure=50)
    # pinch out (scale > 1), two fingers start near center
    device.pinch_zoom([(300, 500), (400, 600)], scale=1.3, duration=2000, steps=12)
    # pinch in (scale < 1)
    device.pinch_zoom([(500, 500), (600, 600)], scale=0.7, duration=2000, steps=12)
# ---
